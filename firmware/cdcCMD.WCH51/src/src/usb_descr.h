...
__xdata __at (EP2_ADDR) uint8_t EP2_bufCDCRX[EP2_SIZE];
__xdata __at (EP2_ADDRTX) uint8_t EP2_bufCDCTX[EP2_SIZE]; //EP2+64
__xdata __at (EP_END)   uint8_t __EP_END__[1];            //Mark
// ===================================================================================
